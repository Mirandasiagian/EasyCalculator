...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    MaterialButton button_c,button_open_braket,button_close_braket;
    MaterialButton button_divide,button_multiply,button_plus,button_min,button_equals;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignId(button_open_braket,R.id.button_open_braket);
        assignId(button_close_braket,R.id.button_close_bracket);
